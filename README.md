...
This repo is designed to be **recruiter-facing**: practical data pairing → multi-input modeling → balanced training → clear evaluation + plots.

---

## Abstract (paper-style, concise)
